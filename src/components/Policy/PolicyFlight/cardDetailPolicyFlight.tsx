                ...
                >
                    <>
                        {openSeeMore === PolicyCriteriaCode.International &&
                            <ItemCriteriaDetailByPolicyFlight
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                    <Box sx={{ display: "grid" }} >
                        ...
                        <Typography variant="button">
                            {listAriLines?.find(el => el.code === (getValueByCode(PolicyCriteriaCode.FlightClass || VALUE_ALL))?.carrier)?.name || ""}
                        </Typography>
                    </Box>
                </Grid>
                <Grid item xs={12}>
                    <Box sx={{ display: "grid" }} >
                        ...
                        <Typography variant="button">
                            {listCabinClass.find(el => el.code === (getValueByCode(PolicyCriteriaCode.CabinClass)?.cabinClass || VALUE_ALL))?.name || ""}
                        </Typography>
                    </Box>
                </Grid>
                {
...
export default CardDetailPolicyFlight;

const ItemCriteriaDetailByPolicyFlight = ({
    label,
    listFlightSelected,
