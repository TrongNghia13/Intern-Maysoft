...
const OrganizationPage: NextApplicationPage = () => {
  const {
    t,
    i18n: { language },
  ...
  return (
    <CompanyLayout>
      <OrganizationListContainer
        title={t("setting:organization_title_list_view")}
...
OrganizationPage.requiredAuth = true;
OrganizationPage.requiredSettinglayout = true;
export default withSSRErrorHandling(OrganizationPage);
